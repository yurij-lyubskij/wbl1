...
func (*Index) N7() {
	fmt.Println("Конкурентно читаем и пишем числа в мапу")
	fmt.Println("Выводятся считанные значения или соообщение,")
	fmt.Println("если по такому ключу еще не успели записать значение")
